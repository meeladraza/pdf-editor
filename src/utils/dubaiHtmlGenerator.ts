...
const HEADER_PX = 180; // top padding + account info block (page 1 only, with buffer)
const TBL_HEADER_PX = 18; // column header row
const FOOTER_ROW_PX = 18; // totals footer row (last page only)
const PAGE_NUM_PX = 8; // page number line
const ROW_HEIGHT_PX = 22; // row height with buffer

// Page 1: header + table header + rows + footer row + page num
const ROWS_PX_P1 =
  A4_HEIGHT_PX - HEADER_PX - TBL_HEADER_PX - FOOTER_ROW_PX - PAGE_NUM_PX;
      ...
      <div style="display: flex; gap: 40px;">
        ...
        <div style="flex: 1;">
          <table style="width: 100%; border-collapse: collapse;">
            <tbody>
              <tr>
                <td style="${LABEL} vertical-align: start; width:35%;">STATEMENT PERIOD:</td>
                <td style="${VALUE} vertical-align: start; width:65%;">${info.fromPeriod} To ${info.toPeriod}</td>
              </tr>
              <tr>
                <td style="${LABEL} vertical-align: start; width:35%;">CURENCY:</td>
                <td style="${VALUE} vertical-align: start; width:65%;">${info.currency}</td>
              </tr>
              <tr>
                <td style="${LABEL} vertical-align: start; width:35%;">ADDRESS:</td>
                <td style="${VALUE} vertical-align: start; width:65%;; white-space: pre-line;">${info.address}</td>
              </tr>
              <tr>
                <td style="${LABEL} vertical-align: start; width:35%;">ACCOUNT TITLE:</td>
                <td style="${VALUE} vertical-align: start; width:65%;">${info.accountTitle}</td>
              </tr>
              <tr>
                <td style="${LABEL} vertical-align: start; width:35%;">TYPE:</td>
                <td style="${VALUE} vertical-align: start; width:65%;">${info.accountType}</td>
              </tr>
              <tr>
                <td style="${LABEL} vertical-align: start; width:35%;">AVAIL. BALANCE:</td>
                <td style="${VALUE} vertical-align: start; width:65%;">${lastBalance}</td>
              </tr>
              <tr>
                <td style="${LABEL} vertical-align: start; width:35%;">OPENING BAL:</td>
                <td style="${VALUE} vertical-align: start; width:65%;">${formatNumber(info.openingBal)}</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div style="flex: 1;">
          <table style="width: 100%; border-collapse: collapse;">
            <tbody>
              <tr>
                <td style="${LABEL} vertical-align: start;">A/C OPENING DATE:</td>
                <td style="${VALUE} vertical-align: start;">${info.acOpeningDate}</td>
              </tr>
              <tr>
                <td style="${LABEL} vertical-align: start;">ACCOUNT NO:</td>
                <td style="${VALUE} vertical-align: start;">${info.accountNo}</td>
              </tr>
              <tr>
                <td style="${LABEL} vertical-align: start;">IBAN A/C NO:</td>
                <td style="${VALUE} vertical-align: start;">${info.iban}</td>
              </tr>
              <tr>
                <td style="${LABEL} vertical-align: start;">&nbsp;</td>
                <td style="${VALUE} vertical-align: start;">&nbsp;</td>
              </tr>
              <tr>
                <td style="${LABEL} vertical-align: start;">BRANCH:</td>
                <td style="${VALUE} vertical-align: start;">${info.branch}</td>
              </tr>
              <tr>
                <td style="${LABEL} vertical-align: start;">CURRENT BALANCE:</td>
                <td style="${VALUE} vertical-align: start;">${lastBalance}</td>
              </tr>
              <tr>
                <td style="${LABEL} vertical-align: start;">RUN DATE:</td>
                <td style="${VALUE} vertical-align: start;">${info.runDate}</td>
              </tr>
              <tr>
                <td style="${LABEL} vertical-align: start;">CLOSING BAL:</td>
                <td style="${VALUE} vertical-align: start;">${lastBalance}</td>
              </tr>
            </tbody>
          </table>
...
const generateTableHeader = () => `
  <thead>
    <tr>
      ...
      <th style="${TH} width: 15.5%;">Debit</th>
      <th style="${TH} width: 12%;">Credit</th>
      <th style="${TH} width: 12%;">Balance</th>
    </tr>
  </thead>
`;
